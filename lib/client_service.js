...
const feed_external_1 = require("./rest/feed_external");
...
const user_notify_1 = require("./rest/user_notify");
class ClientService {
    /**
     *
    ...
    get feedExternal() {
        return this.restFeedExternal !== undefined ? this.restFeedExternal : this.restFeedExternal = new feed_external_1.RestFeedExternal(this.configuration);
    }
    get feedLike() {
    ...
    get userNotify() {
        return this.restUserNotify !== undefined ? this.restUserNotify : this.restUserNotify = new user_notify_1.RestUserNotify(this.configuration);
    }
    get userWall() {
