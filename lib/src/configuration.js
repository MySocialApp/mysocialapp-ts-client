...
class Configuration {
    ...
    postVoid(model, path, body, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const resp = yield this.httpClient.post(path, body.toJson(), this.setDefaultOptions(options, "application/json"));
                return;
    ...
    postMultipart(model, path, body, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // TODO check
                const resp = yield this.httpClient.post(path, body, this.setDefaultOptions(options, "multipart/form-data"));
                model.load(resp.data, this);
                return model;
            }
            catch (error) {
